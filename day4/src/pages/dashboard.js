...
import decor2 from"../assets/images/decor2.jpeg"
import decor3 from "../assets/images/decor3.png"
import decor4 from "../assets/images/decor4.jpeg"
    ...
    <div className="dashboard">
      ...
      <main className="main-content">
        ...
        <div className="image-row">
          <img src={decor1}alt="Image 1" className="dashboard-image" />
          <img src={decor2} alt="Image 2" className="dashboard-image" />
        </div>
        <div className="image-row">
          <img src={decor3} alt="Image 3" className="dashboard-image" />
          <img src={decor4}alt="Image 4" className="dashboard-image" />
        </div>
